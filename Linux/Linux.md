...
Learned to leverage various commands, including uname, pwd, env, ifconfig, ls, cd, mkdir, touch, mv, cp, cat, find, which, locate, man, more, less, head, tail, sort, grep, wc, cut, tr, netstat, ps, curl, systemctl, crontab, ssh, wget, rsync, Deja Dup, Duplicity, fdisk, mount, docker, ifconfig, ip, and iptables. These commands provide the power to interact with the system, manage files and directories, query information, filter and manipulate data, configure networking, automate tasks, connect remotely, transfer files, secure backups, manage storage, containerize applications, and establish firewalls.
...
Task Scheduling:
Discovered the power of crontab for automating tasks to run at specified times or intervals.
Networking:
Delved into the fundamental concepts of network communication on Linux systems, including configuration using ifconfig and ip.
Web Services:
